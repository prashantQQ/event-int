...
class ContentItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content_item" do
    assert_difference('ContentItem.count') do
      post content_items_url, params: { content_item: { content_title: @content_item.content_title, publish_date: @content_item.publish_date, publishing_target: @content_item.publishing_target } }
    end
  ...
  test "should update content_item" do
    patch content_item_url(@content_item), params: { content_item: { content_title: @content_item.content_title, publish_date: @content_item.publish_date, publishing_target: @content_item.publishing_target } }
